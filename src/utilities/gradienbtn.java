...
public class gradienbtn extends JButton {
        ...
        if (mousePressed == true) {
            ...
            if (iskAllowTab()) {
                ...
                for (int i = 0; i < comp.length; i++) {
                    if (comp[i] instanceof gradienbtn) {

                        ((gradienbtn) comp[i]).setSelected(false);
                        ((gradienbtn) comp[i]).setBorder(BorderFactory.createMatteBorder(0, 0, 0, 0, kIndicatorColor));
                    }
                }
